...
```
## Настройка clang-format clang-tidy в VS Code

VsCode имеет встроенную поддержку clang-format, по умолчанию устанавливается clang-format style=file, что значит, что clang-format файл с ищется в текущей директории. Если файл не найден, используется стиль, установленный по умолчанию в `C_Cpp.clang_format_fallbackStyle`. Можно настроить исправление при сохранении, копировании и другие опции.
